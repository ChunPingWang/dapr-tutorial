# Dapr + Java 23 + Spring Boot 4 教學指南

> 本教學帶領初學者從零開始，使用 Dapr、Java 23 與 Spring Boot 4 建立分散式微服務應用，
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <name>dapr-demo</name>
    <description>Dapr + Java 23 + Spring Boot 4 示範專案</description>
...
git commit -m "feat: 初始化 Spring Boot 4 + Java 23 專案結構與健康檢查端點"
...
Spring Boot 4 基於 Spring Framework 7，API 向下相容，大部分功能應可正常運作。
若遇到問題，請查閱 [Dapr Java SDK GitHub Issues](https://github.com/dapr/java-sdk/issues)。
...
- [JDK 23 新功能](https://openjdk.org/projects/jdk/23/)
